...
UPDATE `flowable-sql`.ACT_CMMN_DATABASECHANGELOGLOCK SET LOCKED = 1, LOCKEDBY = '192.168.3.118 (192.168.3.118)', LOCKGRANTED = '2019-05-23 13:37:30.803' WHERE ID = 1 AND LOCKED = 0;
